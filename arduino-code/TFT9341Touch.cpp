...
/*
void tft9341touch::print (int num)
{
	char str[32];
...
void tft9341touch::println (int num)
{
	print (num);
	_x = 0;
	_y += 8 * _fontSize +2;
...
void tft9341touch::print (unsigned int num)
{
	char str[32];
...
void tft9341touch::println (unsigned int num)
{
	print (num);
	_x = 0;
	_y += 8 * _fontSize +2;
...
void tft9341touch::print (int num, uint8_t radix)
{
	char str[33];
	itoa (num, str, radix);
	print (str);
...
void tft9341touch::println (int num, uint8_t radix)
{
	print (num, radix);
	_x = 0;
	_y += 8 * _fontSize +2;
...
void tft9341touch::print (unsigned int num, uint8_t radix)
{
	char str[33];
...
void tft9341touch::println (unsigned int num, uint8_t radix)
{
	print (num, radix);
	_x = 0;
	_y += 8 * _fontSize +2;
...
void tft9341touch::printHebrewRaw (char *str)
{
	int8_t i=0;
	while(str[i++]);
	i--;
...
void tft9341touch::putRgbColorPixel(uint8_t r, uint8_t g, uint8_t b)
{
	...
	//SPI.transfer(colorPixel>>8);
	//SPI.transfer(colorPixel);
