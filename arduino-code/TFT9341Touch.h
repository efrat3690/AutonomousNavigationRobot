...
public:
	...
	void print (int num, uint8_t radix);
	void println (int num, uint8_t radix);
	void print (unsigned int num, uint8_t radix);
	void println (unsigned int num, uint8_t radix);*/
